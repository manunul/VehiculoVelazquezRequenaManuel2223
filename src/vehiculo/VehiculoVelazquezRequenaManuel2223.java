 ...
 */
public class VehiculoVelazquezRequenaManuel2223 {
    ...
    public VehiculoVelazquezRequenaManuel2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoVelazquezRequenaManuel2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
